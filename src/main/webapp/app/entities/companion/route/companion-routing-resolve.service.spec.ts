...
describe('Companion routing resolve service', () => {
  ...
  let resultCompanion: ICompanion | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCompanion).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICompanion>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
