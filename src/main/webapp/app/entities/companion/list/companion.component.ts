...
import { EntityArrayResponseType, CompanionService } from '../service/companion.service';
...
export class CompanionComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICompanion): number => this.companionService.getCompanionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.companions = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICompanion[] | null): ICompanion[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.companionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
