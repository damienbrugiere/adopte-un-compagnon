...
describe('Companion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'companion', component: CompanionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.companions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to companionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCompanionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCompanionIdentifier).toHaveBeenCalledWith(entity);
